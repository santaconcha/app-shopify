...
export interface WebhookContextWithSession<Resources extends ShopifyRestResources, Topics = string | number | symbol> extends Context<Topics> {
    /**
...
export type WebhookContext<Resources extends ShopifyRestResources, Topics = string | number | symbol> = WebhookContextWithoutSession<Topics> | WebhookContextWithSession<Resources, Topics>;
export type AuthenticateWebhook<Resources extends ShopifyRestResources, Topics = string | number | symbol> = (request: Request) => Promise<WebhookContext<Resources, Topics>>;
export {};
